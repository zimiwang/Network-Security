...
public class OriginalAliceClient {
    ...
    public void requestCommunicationWithBob() throws Exception{
        ...
        try (Socket socket = new Socket(host, bobPort);
            ...
            System.out.println("CBC encrypted KAB_{N2-1, N3} output : " + str_Kab_decrementN2_N3);
            System.out.println("CBC decrypted N2-1 output : " + str_decrementN2);
            System.out.println("CBC decrypted N3 output : " + str_N3);
            System.out.println("CBC decrypted N3-1 output : " + str_decrementN3);
            System.out.println("CBC encrypted N3-1 output : " + str_encrypted_decrementN3);
